    ...
    this.dataServ.getResponse({
      ...
      .then((response) => {
        ...
        if (response.errorMsg || response.errorMsg != undefined) {
          ...
          response && response[0] && response[0].rows.length > 0) {
          ...
          // this.photo = img.src
            ...
            imgType === 'image/jpg' &&  this.imageModal(imgData,'data:image/jpg;base64,',)

            imgType === 'image/jpeg' &&   this.imageModal(imgData,'data:image/jpeg;base64,')

            imgType === 'application/pdf' &&  this.previewFile(imgData, 'application/pdf',imgname)
