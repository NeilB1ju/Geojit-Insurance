...
export class CompanyMasterComponent implements OnInit {
  ...
  Save() {
    ...
    if (
      ...
      this.model.ProductType == undefined
    ) {
    ...
    if (
      this.model.Afsm == "" ||
      this.model.Afsm == null ||
      this.model.Afsm == undefined
    ) {
