...
export class clientmergingComponent implements OnInit {
        ...
        detailArray: [
          {
            ...
            Address:
              this.CAddress && this.model.Address ? this.model.Address : "",
  ...
  getclientdetails() {
    this.dataServ
      ...
      .then((response) => {
        ...
        this.model.Address =
          res1[0].ContactAddress1 +
          "," +
          res1[0].ContactAddress2 +
          "," +
          res1[0].ContactAddress3;
      });
  }
  ...
  Merge1() {
    ...
    for (let i = 0; i < this.tablelist.length; i++) {
      if (this.tablelist[i].checked == true) this.arrey.push(this.tablelist[i]);
    }
    if (this.arrey.length == 0) {
