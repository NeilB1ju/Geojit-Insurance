    ...
    if (data && type) {
      if (type === 'state') {
        ...
        this.locationFindopt = {
          ...
          title: 'LocationName',
          hasDescInput: false,
          whereClause: data.RegionName ? "regionname ='" + data.RegionName + "'" : '',
          requestId: 2,
        }
      }
    }
    ...
    this.dataServ.getResponse({
      ...
      "detailArray":
        [{
          ...
          "FromDate": this.model.transferFromDate ? moment(this.model.transferFromDate).format(AppConfig.dateFormat.apiMoment) : '',
          "ToDate": this.model.transferToDate ? moment(this.model.transferToDate).format(AppConfig.dateFormat.apiMoment) : '',
