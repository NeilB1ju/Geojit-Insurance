...
import { FindOptions, DataService, AuthService, UtilService, FormHandlerComponent } from "shared";
...
export class FTMReportComponent implements OnInit {
  ...
  ReportType:any
  rpttype:any=[{Code:'L',Description:'Login'},{Code:'I',Description:'Issuance'}];
  state:any;
...
this.yeardata=[]
      ...
      if(this.MorY=='Y')
      {
        if(this.Finyear =='' || this.Finyear ==null || this.Finyear ==undefined)
        {
