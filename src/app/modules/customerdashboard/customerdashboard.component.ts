...
export class customerdashboard implements OnInit {
  ...
  viewCustomerData(data) {debugger
    ...
    this.dataServ.getResultArray({
      ...
      "detailArray":
        [{
          ...
          ApplicationNo: this.model.filter == 'AN' ? this.model.filterValue : '',
          MobileNumber: this.model.filter == 'MN' ? this.model.filterValue : '',
